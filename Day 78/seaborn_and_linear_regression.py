...
Original file is located at
    https://colab.research.google.com/drive/1wvktvblyI3ZErfblC7RgGJKpAtP3bgIR
...
films_not_released_yet=data[data['Release_Date']>scrape_date]
films_not_released_yet
data_clean = data.drop(films_not_released_yet.index)
...
dti = pd.DatetimeIndex(data=data_clean["Release_Date"])
decades = dti.year // 10 * 10
decades
...
print(old_films.sample(2))
print(new_films.sample(2))
print(f"{old_films.shape[0]} + {new_films.shape[0]} = {data_clean.shape[0]}")
...
ax.set(xlabel="Revenue in $ billions",
...
revenue = regression.predict([[budget]])[0]
print(revenue)